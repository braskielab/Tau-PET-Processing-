...
#-----------------------------------------------------------------
echo "STAGE 15: STEP 1 -->  ${subj} CALCULATE ROI ${ROI} MEAN SUVR (REF ADJUSTED)"
PET_MEAN=$(${FSLSTATS} ${WEIGHTED}/adj/${subj}_adjTAUPET_${ROI}.nii.gz -M)
echo -e "STAGE 15: STEP 1 -->  ${subj} CALCULATE ROI ${ROI} MEAN SUVR = ${PET_MEAN} \r\n" >> ${NOTE}

#-----------------------------------------------------------------
#STEP (2) - INSERT PET VALUES BY ROI
#-----------------------------------------------------------------
echo "STAGE 15: STEP 2 -->  INSERT ${subj} ROI MEAN SUVR IN CSV FILE"
